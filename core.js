...
const _PRIVATE_POOL = [
  ...
  // 钢管舞
  '消防员旋转（fireman spin）', '钢管侧悬抬腿', '钢管悬挂收腹', '靠杆后弯展胸',
  // 水中
...
const DB = {
  ...
  core: [
    ...
    { n: '消防员旋转（fireman spin）', eq: ['健身房全套'], muscle: ['核心', '上肢', '下肢'], diff: 2, note: '外手握杆肩高，内手握杆胸高，内脚踩杆侧面，外腿摆出借惯性绕杆旋转一圈，身体弧形贴杆，控制落地', u: '次' },
    { n: '钢管侧悬抬腿', eq: ['健身房全套'], muscle: ['腹斜', '核心', '下肢'], diff: 3, note: '侧身双手握杆悬挂，腋下夹紧，双腿伸直侧向抬起，腹斜发力，顶端停顿，缓慢下放，左右各做', u: '次', bi: true },
    { n: '钢管悬挂收腹', eq: ['健身房全套'], muscle: ['核心', '上肢'], diff: 2, note: '双手头顶握杆悬挂，核心收腹将膝盖提至胸口，顶端停顿1秒再缓慢伸直，避免摆荡借力', u: '次' },
    { n: '靠杆后弯展胸', eq: ['健身房全套'], muscle: ['脊柱', '胸大肌', '核心'], diff: 2, note: '背贴杆站立，双手向后环抱握住杆，胸椎主动后弯，肩胛下沉后收，充分展开前胸，停顿2次深呼吸再还原', u: '秒' }
  ],
  cardio: [
